...
object AB311140A extends UserDetailsData {
  ...
  override val description: String = "LSP2 Return - threshold reached, second stage rejected, under first stage appeal"
