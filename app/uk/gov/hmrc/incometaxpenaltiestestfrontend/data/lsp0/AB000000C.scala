...
object AB000000C extends UserDetailsData {

  val lspSummary = LSPSummary()
  private val penaltyNumber: String = "005000001080"
  val lspPenalty1: LSPDetails = LateSubmissionPenaltyDetails.expired(
    ReportingPeriod(2025, None)).withPenaltyNumber(penaltyNumber)
  ...
  override val nino: String = "AB000000C"
