...
object AA100011A extends UserDetailsData {
  ...
  override val description: String = "1 LPP - 15-30 days, tax paid - (1 LPP1 DUE) 2027-2028"
  override val descriptionOverdue: Option[String] = Some("1 LPP - 31+ days, tax paid - (1 LPP1 OVERDUE) 2027-2028")
