...
object AA200001A extends UserDetailsData {
  ...
  private val principalChargeReference = "XJ002616061032"
  ...
  override val nino: String = "AA200001A"
  override val mtdItId: String = "20000"
  override val utr: String = "1000020000"
  override val description: String = "2 LPPs - (1 LPP2 ESTIMATE, 1 LPP1 DUE) 2027-2028"
  override val descriptionOverdue: Option[String] = Some("2 LPPs - (1 LPP2 ESTIMATE, 1 LPP1 OVERDUE) 2027-2028")
  override val timemachineDate: String = "05/03/2029"
  override val timeMachineDateOverdue: Option[String] = Some("20/05/2029")
}
