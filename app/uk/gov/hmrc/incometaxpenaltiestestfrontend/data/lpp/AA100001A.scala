...
object AA100001A extends UserDetailsData {
  ...
  override val nino: String = "AA100001A"
  override val mtdItId: String = "10000"
  override val utr: String = "1000010000"
  override val description: String = "1 LPP - 15-30 days, tax unpaid - (1 LPP1 ESTIMATE) 2027-2028"
  override val timemachineDate: String = "19/02/2029"
}
