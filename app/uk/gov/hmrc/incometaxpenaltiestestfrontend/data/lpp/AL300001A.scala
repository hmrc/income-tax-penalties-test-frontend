...
import uk.gov.hmrc.incometaxpenaltiestestfrontend.models.hip.penaltyDetails.{AppealInformation, LPP, LPPDetails}

object AL300001A extends UserDetailsData {

  private val principalChargeReference = "XJ002616061056"
  private val principalChargeReference2 = "XJ002616061096"
  private val principalChargeReference3 = "XJ002616061006"
  ...
  val latePaymentPenaltyDetails1: LPPDetails = LatePaymentPenaltyDetails.lpp1Penalty(
    ...
    amount = 60.00,
    isTaxPaid = false
  ).withChargeReference(principalChargeReference).withAppealInformation(AppealInformation.create("Upheld", "First"))
  ...
  val latePaymentPenaltyDetails3: LPPDetails = LatePaymentPenaltyDetails.lpp1DueOrOverdue(
    reportingPeriod2,
    amount = 60.00
  ).withChargeReference(principalChargeReference2).withAppealInformation(AppealInformation.create("Upheld", "Second"))
  ...
  val latePaymentPenaltyDetails4: LPPDetails = LatePaymentPenaltyDetails.lpp2DueOrOverdue(
    ...
    .withIncomeTaxPaid(reportingPeriod1, false)
    .withAppealInformation(AppealInformation.create("Upheld", "Second"))

  val latePaymentPenaltyDetails5: LPPDetails = LatePaymentPenaltyDetails.lpp1Paid(
    reportingPeriod1,
    amount = 60.00
  ).withChargeReference(principalChargeReference3).withAppealInformation(AppealInformation.create("Upheld", "Tribunal"))
  ...
  val latePaymentPenaltyDetails6: LPPDetails = LatePaymentPenaltyDetails.lpp2Paid(
    ...
    .withIncomeTaxPaid(reportingPeriod1, false)
    .withAppealInformation(AppealInformation.create("Upheld", "Tribunal", hasSkipped = true))
