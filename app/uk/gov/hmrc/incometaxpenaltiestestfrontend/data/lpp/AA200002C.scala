...
object AA200002C extends UserDetailsData {
  ...
  private val principalChargeReference = "XJ002616061074"
  ...
  ).withChargeReference(principalChargeReference).copy(lpp1HRCalculationAmt = Some(2000.00), lpp1LRCalculationAmt = Some(2000.00))
  ...
  override val description: String = "Breathing Space (Charge before and after BS) - 2 LPPs (1 LPP2 ESTIMATE, 1 LPP1 OVERDUE)"
