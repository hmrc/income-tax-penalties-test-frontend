...
import uk.gov.hmrc.incometaxpenaltiestestfrontend.data.lpp.AL100001B.latePaymentPenaltyDetails2
...
object AL100000A extends UserDetailsData {
  ...
  override val nino: String = "AL100000A"
  override val mtdItId: String = "10000"
  override val utr: String = "1000010000"
  override val description: String = "1 LPP - 31 + days, tax unpaid penalty due"
  override val descriptionOverdue: Option[String] = Some("1 LPP - 31 + days, tax unpaid penalty overdue")
