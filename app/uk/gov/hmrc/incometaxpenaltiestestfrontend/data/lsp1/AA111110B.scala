...
object AA111110B extends UserDetailsData {
  ...
  private val penaltyNumber: String = "005000001001"
  val lspPenalty1: LSPDetails = LateSubmissionPenaltyDetails.adjusted(
    ReportingPeriod(2027, Some(1))).withPenaltyNumber(penaltyNumber)
