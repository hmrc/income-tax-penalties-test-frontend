...
object AA111131A extends UserDetailsData {

  val lspSummary = LSPSummary(
    activePenaltyPoints = 1
  )

  val appealInformation = AppealInformation.create("Rejected", "Second")
  private val penaltyNumber: String = "005000001074"
  ...
  override val nino: String = "AA111131A"
  override val mtdItId: String = "11131"
  override val utr: String = "1000011131"
  override val description: String = "1 LSP Update - (ACTIVE - second stage appeal rejected)"
